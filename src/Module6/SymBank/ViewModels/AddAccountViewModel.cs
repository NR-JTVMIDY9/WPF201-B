...
namespace SymBank.ViewModels
{
    public class AddAccountViewModel : BaseViewModel
    {
        ...
        public Brush AccountTypeBrush
        {
            get
            {
            //    return (Brush)_accountTypeBrushConverter.Convert(
            //        _account.Type, typeof(Brush), null, null);
                return TypeBrushes[(int)_account.Type];
            }
        }

        private AccountTypeToBrushConverter _accountTypeBrushConverter;

        //public AccountTypeToBrushConverter AccountTypeBrushConverter
        //{
        //    get { return _accountTypeBrushConverter; }
        //}
        ...
        {
            ClearPictureCommand = new RelayCommand(p => _account.Picture = null);
            ...
            _accountTypeBrushConverter = new AccountTypeToBrushConverter();
